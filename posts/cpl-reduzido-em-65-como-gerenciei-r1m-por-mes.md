# Como reduzimos o CPL em 65% gerindo R$1M por mês em mídia

Gerenciar R$1 milhão por mês em mídia paga não é sobre gastar muito.

É sobre **não desperdiçar nada**.
...
O G4 Educação operava com:

- **Meta Ads** como principal canal
- **Orçamento de ~R$1M/mês**
- **CPL médio de R$20**
- **Segmentação ampla**, baseada em interesses genéricos
- **Criativos variados** sem padrão de teste claro
...
### Alavanca 1: Segmentação por estágio de decisão

Antes, todo mundo via o mesmo anúncio.
...
- Professor olhando para câmera, sem roteiro decorado
- Background de sala de aula ou escritório real
- Problemas reais dos alunos no primeiro minuto
- CTA pegando a emoção do momento ("você não precisa continuar sozinho")

### Alavanca 3: Eliminação de desperdício por auditoria semanal
...
O remarketing padrão é jogar o mesmo anúncio para todo mundo que visitou o site.
...
Importante mostrar o que testamos e não deu certo:

### 1. Segmentação por cargo
Tentamos segmentar por "Head de Marketing", "Diretor de Educação" etc. O CPL subiu 30% e o volume caiu. O decisor de compra na educação executiva não segue padrão de cargo.

### 2. Criativos "profissionais" demais
Produção mais cara não significou CPL mais baixo. Na verdade, vídeos mais crus e autênticos converteram melhor que vídeos com edição pesada.

### 3. Automatização total de lances
Deixamos o Meta Ads otimizar sozinho por 2 semanas. CPL subiu 25%. Voltei para ajuste manual com revisão semanal.
...
## O que levo desse aprendizado

Reduzir CPL não é sobre achar o público "perfeito". É sobre **eliminar desperdício sistematicamente**.
...
*Esse case me marcou porque provou algo que carrego até hoje: orçamento grande não é desculpa para resultado mediano. Na verdade, quanto maior a verba, maior a responsabilidade de gastar cada centavo com inteligência.*
