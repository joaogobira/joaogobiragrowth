# Viver com TDAH no mercado de trabalho: o que ninguém te conta

Vou começar com uma verdade incômoda:

TDAH não é superpoder. Não é "déficit de atenção com bonus de criatividade". Não é um jeitinho diferente de funcionar.
...
### 1. O hiperfoco é real, mas ele não escolhe o que é importante
...
### 2. Você vai ser chamado de tudo: preguiçoso, distraído, desorganizado

Antes do diagnóstico, eu ouvia:
...
### 3. A culpa é uma companheira constante

A culpa de saber que você poderia ter feito melhor. A culpa de atrasar uma entrega que dependia só de você. A culpa de olhar para o lado e ver colegas "normais" produzindo sem esse esforço hercúleo.

Essa culpa cansa. E cansa mais que o trabalho em si.

---

## O que funciona para mim

Depois de anos testando, aqui está o que realmente faz diferença no meu dia a dia:

### Sistema 1: Externalização da memória

Se não está escrito, não vai acontecer.

Ponto. Não confio na minha cabeça para lembrar prazos, reuniões ou tarefas. Tudo vai para:

- **Notion** para tarefas e projetos
- **Google Calendar** para tudo que tem horário
- **Bloco físico** para ideias que surgem fora do computador

Não uso um sistema só. Uso três. Porque quando um falha (e vai falhar), o outro segura.

### Sistema 2: Blocos de tempo, não listas de tarefas

Lista de tarefas é uma armadilha para quem tem TDAH. Você coloca 10 itens, faz 2, e passa o resto do dia se sentindo um fracasso.

Troquei lista por **blocos de tempo**:

- 9h-11h: Trabalho profundo (sem Slack, sem e-mail)
- 11h-12h: Reuniões e alinhamentos
- 14h-16h: Execução e entregas
- 16h-17h: Reserva para imprevistos
...
- Cafeteira programada para desligar = hora de levantar
- Relógio vibrando a cada 25 minutos (técnica pomodoro adaptada)
- Tênis de corrida perto da mesa = lembrete para pausa ativa

Não é bonito. Não é high-tech. Funciona.
...
- **Pensamento não linear** enxerga conexões que outros não veem
- **Sensibilidade a padrões** identifica oportunidades escondidas nos dados
- **Urgência natural** resolve crises com rapidez
...
1. **Não é culpa sua.** Você não é preguiçoso. Seu cérebro funciona diferente.
2. **Busque diagnóstico.** O tratamento muda tudo. Literalmente.
3. **Construa sistemas, não confie em motivação.** Motivação vai embora. Sistema fica.

E por favor: não se compare com profissionais neurotípicos. Você não está competindo na mesma categoria. E está tudo bem.

---

*Essa é a primeira vez que escrevo publicamente sobre TDAH. Se serviu para uma pessoa que está lendo se sentir menos sozinha, já valeu.*
